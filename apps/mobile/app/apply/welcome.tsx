...
/** A1 · Welcome — Customer onboarding start screen. */
export default function CustomerWelcome() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: surface.applicant }}>
      ...
      >
        <Text variant="micro">Parakh Customer</Text>
        ...
        <View style={{ marginTop: space.xxxl, gap: space.md }}>
          <Button
            label="Get started →"
            onPress={() => router.push('/apply/identity')}
          />
          ...
          {/* Simple, clean text link for officers */}
          <Pressable
            onPress={() => router.push('/officer/sign-in')}
            hitSlop={12}
            style={{ marginTop: space.xs }}
          >
            <Text variant="caption" tone="fog" center style={{ textDecorationLine: 'underline' }}>
              Compliance officer? Sign in here
            </Text>
          </Pressable>
        </View>
      </ScrollView>
